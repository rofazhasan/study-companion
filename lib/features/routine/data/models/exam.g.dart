...
const ExamSchema = CollectionSchema(
  ...
  indexes: {},
  links: {},
  embeddedSchemas: {r'ExamSubject': ExamSubjectSchema},
  getId: _examGetId,
...
int _examEstimateSize(
  ...
  {
    final offsets = allOffsets[ExamSubject]!;
    for (var i = 0; i < object.subjects.length; i++) {
      final value = object.subjects[i];
      bytesCount += ExamSubjectSchema.estimateSize(value, offsets, allOffsets);
    }
  }
  return bytesCount;
}
...
void _examSerialize(
  ...
  writer.writeObjectList<ExamSubject>(
    offsets[1],
    allOffsets,
    ExamSubjectSchema.serialize,
    object.subjects,
  );
}
...
Exam _examDeserialize(
  ...
  object.subjects = reader.readObjectList<ExamSubject>(
        offsets[1],
        ExamSubjectSchema.deserialize,
        allOffsets,
        ExamSubject(),
      ) ??
      [];
...
P _examDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readObjectList<ExamSubject>(
            offset,
            ExamSubjectSchema.deserialize,
            allOffsets,
            ExamSubject(),
...
extension ExamQueryFilter on QueryBuilder<Exam, Exam, QFilterCondition> {
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'subjects',
        0,
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'subjects',
        0,
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExamQueryObject on QueryBuilder<Exam, Exam, QFilterCondition> {
  QueryBuilder<Exam, Exam, QAfterFilterCondition> subjectsElement(
      FilterQuery<ExamSubject> q) {
    return QueryBuilder.apply(this, (query) {
...
extension ExamQueryProperty on QueryBuilder<Exam, Exam, QQueryProperty> {
  ...
  QueryBuilder<Exam, List<ExamSubject>, QQueryOperations> subjectsProperty() {
    return QueryBuilder.apply(this, (query) {
...
const ExamSubjectSchema = Schema(
  name: r'ExamSubject',
  id: -1757494908469539898,
  properties: {
  ...
  estimateSize: _examSubjectEstimateSize,
  serialize: _examSubjectSerialize,
  deserialize: _examSubjectDeserialize,
  deserializeProp: _examSubjectDeserializeProp,
);

int _examSubjectEstimateSize(
  ExamSubject object,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
...
ExamSubject _examSubjectDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ExamSubject();
...
P _examSubjectDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension ExamSubjectQueryFilter
    on QueryBuilder<ExamSubject, ExamSubject, QFilterCondition> {
  QueryBuilder<ExamSubject, ExamSubject, QAfterFilterCondition> dateTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'dateTime',
  ...
  QueryBuilder<ExamSubject, ExamSubject, QAfterFilterCondition>
      dateTimeGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
  ...
  QueryBuilder<ExamSubject, ExamSubject, QAfterFilterCondition> dateTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExamSubjectQueryObject
    on QueryBuilder<ExamSubject, ExamSubject, QFilterCondition> {}
